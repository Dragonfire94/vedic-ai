# CHANGELOG_PRD v1.2.26

- Source PRD: `PRODUCT_SPEC_PRD_v1_2_26.md`
...
- Target state: 이 PRD는 backend-only `life_cycle-lite` P0 전환 계약을 잠그며, backend-only라도 product-aware finalizer/cache/PDF contract가 함께 닫혀 있어야 합니다. repo-wide 완료 주장은 frontend/README migration 이후에만 허용합니다.
