...
def render_life_cycle_lite_markdown(payload: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "",
        "## How to use 1p",
        f"- 1단계: 먼저 인생 구조 한 장 요약에서 지금 어디쯤 와 있는지 확인합니다.",
        f"- 2단계: 4단계 인생 구조에서 큰 흐름을 보고, 현재 위치 섹션으로 다시 내려옵니다.",
        f"- 3단계: 마하다샤 단계 목록에서 전환 시점과 반복되는 행성 톤을 비교합니다.",
        ...
        *_render_stage_lines(payload),
        ...
        "",
        "## 마하다샤 단계 목록",
        *_render_mahadasha_lines(payload),
        "",
        "## 방법론 카드",
