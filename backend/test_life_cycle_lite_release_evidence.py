...
MANUAL_QA_PATH = EVIDENCE_DIR / "life_cycle_lite_manual_qa.md"
SAMPLE_RESPONSE_PATH = EVIDENCE_DIR / "life_cycle_lite_sample_response.json"
GATE_SUMMARY_PATH = EVIDENCE_DIR / "life_cycle_lite_gate_summary.json"
MANIFEST_PATH = EVIDENCE_DIR / "life_cycle_lite_release_manifest.json"
...
def test_life_cycle_lite_release_manifest_matches_evidence_hashes_and_identity() -> None:
    ...
    assert manifest["render_profile"] == "life_cycle_lite_v1"
    ...
    assert manual_meta["release_manifest_path"] == "PRD/release_evidence/v1_4_0/life_cycle_lite_release_manifest.json"
    ...
    assert manifest["manual_qa_path"] == "PRD/release_evidence/v1_4_0/life_cycle_lite_manual_qa.md"
    assert manifest["sample_response_path"] == "PRD/release_evidence/v1_4_0/life_cycle_lite_sample_response.json"
    assert manifest["gate_summary_path"] == "PRD/release_evidence/v1_4_0/life_cycle_lite_gate_summary.json"
